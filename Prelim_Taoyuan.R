...
zhang2$birthkey <- ifelse(grepl("生育|生孩子|孕育|懷孕|育兒|育嬰|新生兒|托嬰|公托|臨托|產檢",zhang2$Message),1,0)
lai2$birthkey <- ifelse(grepl("生育|生孩子|孕育|懷孕|育兒|育嬰|新生兒|托嬰|公托|臨托|產檢",lai2$Message),1,0)
lin2$birthkey <- ifelse(grepl("生育|生孩子|孕育|懷孕|育兒|育嬰|新生兒|托嬰|公托|臨托|產檢",lin2$Message),1,0)
peng2$birthkey <- ifelse(grepl("生育|生孩子|孕育|懷孕|育兒|育嬰|新生兒|托嬰|公托|臨托|產檢",peng2$Message),1,0)
